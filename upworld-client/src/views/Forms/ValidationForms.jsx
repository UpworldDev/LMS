                                    ...
                                    content={
                                        <div>
                                            ...
                                            <FormGroup controlId="formHorizontalEmail">
                                                ...
                                                <Col sm={6}>
                                                    <FormControl type="email" name="type_email" onChange={(event) => {
                                            ...
                                            <FormGroup controlId="formHorizontalURL">
                                                ...
                                                <Col sm={6}>
                                                    <FormControl type="text" name="type_url" onChange={(event) => {
                                            ...
                                            <FormGroup controlId="formHorizontalEqualTo">
                                                ...
                                                <Col sm={3}>
                                                    <FormControl type="text" name="type_source" placeholder="idSource" onChange={(event) => {
                                                ...
                                                <Col sm={3}>
                                                    <FormControl type="text" name="type_destination" placeholder="idDestination" onChange={(event) => {
