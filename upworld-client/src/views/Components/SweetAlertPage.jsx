        ...
        this.setState({
            alert: (
                <SweetAlert
                    ...
                    confirmBtnBsStyle="info"
                >
                    You can use <b>bold</b> text, <a href="https://www.upworldinc.org/">links</a> and other HTML tags
                </SweetAlert>
            )
        });
    }
        ...
        this.setState({
            alert: (
                <SweetAlert
                    ...
                    confirmBtnBsStyle="info"
                    title={
                        <p>You entered: <b>{inputValue}</b></p>
                    }
                />
            )
        });
            ...
            <div className="main-content">
                ...
                <Grid fluid>
                    <Card
                        ...
                        category={
                            <div>
                                A beautiful plugin, that replace the classic alert, Handcrafted by our friend <a href="https://github.com/djorg83" target="_blank" rel="noopener noreferrer">Daniel Jorgensen</a>. Please check out the <a href="https://github.com/djorg83/react-bootstrap-sweetalert" target="_blank" rel="noopener noreferrer">full documentation</a>.
                            </div>
                        }
                    />
                            ...
                            <Col md={3}>
                                <Card
                                    ...
                                    content={
                                        <div>
                                            <h5>Basic example</h5>
                                            <Button fill onClick={this.basicAlert.bind(this)}>Try me!</Button>
                                        </div>
                                    }
                                />
                            </Col>
                                ...
                                <Card
                                    ...
                                    content={
                                        <div>
                                            ...
                                            <Button fill onClick={this.titleAndTextAlert.bind(this)}>Try me!</Button>
                                ...
                                <Card
                                    ...
                                    content={
                                        <div>
                                            ...
                                            <Button fill onClick={this.htmlAlert.bind(this)}>Try me!</Button>
                                        </div>
                                    }
                                />
                            </Col>
                                ...
                                <Card
                                    ...
                                    content={
                                        <div>
                                            ...
                                            <Button fill onClick={this.warningWithConfirmAndCancelMessage.bind(this)}>Try me!</Button>
                                        </div>
                                    }
                                />
                            </Col>
                                ...
                                <Card
                                    ...
                                    content={
                                        <div>
                                            ...
                                            <Button fill onClick={this.autoCloseAlert.bind(this)}>Try me!</Button>
                                        </div>
                                    }
                                />
                            </Col>
                                ...
                                <Card
                                    ...
                                    content={
                                        <div>
                                            ...
                                            <Button fill onClick={this.inputAlert.bind(this)}>Try me!</Button>
                                        </div>
                                    }
                                />
                            </Col>
